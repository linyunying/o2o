 ...
 * 获取关注公众号之后的微信用户信息的接口，如果在微信浏览器里访问
  https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxe632f99c390123a2&
  redirect_uri=http://o2o.myfirsto2o.cn/o2o/wechatlogin/logincheck&role_type=1&
...
public class WechatLoginController {
	...
	/**
	 * 公众号里面有两个按钮，一个是前端展示页面，一个是店家管理系统
	 * 所以我们设定两个常量，当返回值state=1时则代表用户选择前端展示页面
	 * state=2则代表用户选择店家管理系统
	 */
